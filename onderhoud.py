...
def plot_bike_data(month_name):
    # Haal de juiste bestand op basis van de maand
    file_name = file_month_dict[month_name]
    
    # Laad de geselecteerde dataset
    ...
    # Zet de totale duur om van seconden naar uren (gebruik .loc om waarschuwing te vermijden)
