...
# Tabs aanmaken
tab1, tab2, tab3 = st.tabs(["🚇 Metro Stations en Lijnen", "🚲 Fietsverhuurstations", "🌤️ Weer en fietsverhuur correlatie"])
...
with tab3:
    st.header("🌤️ Weer en fietsverhuurdata voor 2021")
...
# Streamlit-app titel
st.subheader("Correlatie tussen fietsverhuur en weer")
